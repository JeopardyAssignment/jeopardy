...
public class QuestionService {
     ...
     * Uses the Strategy pattern to support multiple file formats (CSV, JSON, XML).
     *
    ...
    /**
     * Gets a specific unanswered question by category and value.
     *
     ...
     * Values are returned in sorted ascending order.
     *
